...
public class PGPFileProcessor {
    ...
    public boolean encrypt() throws Exception {
        ...
        PGPUtils.encryptFile(out, inputFileName, PGPUtils.readPublicKey(keyIn, keyFingerPrintCalculator), asciiArmored, integrityCheck);
        out.close();
        keyIn.close();
        return true;
    }
    ...
    public boolean signEncrypt() throws Exception {
        ...
        PGPPublicKey publicKey = PGPUtils.readPublicKey(publicKeyIn, keyFingerPrintCalculator);
        PGPSecretKey secretKey = PGPUtils.readSecretKey(secretKeyIn, keyFingerPrintCalculator);
