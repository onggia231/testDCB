...
public class VasgateDispatcher extends CBDispatcherManager {
    ...
    protected Dispatcher prepareDispatcher() throws Exception {
        return new VasgateDispatcherSplitThread(this);
    }
    ...
    protected void fillDispatcherParameter(Dispatcher thr) throws Exception {
        ...
        VasgateDispatcherSplitThread splitthr = (VasgateDispatcherSplitThread) thr;
