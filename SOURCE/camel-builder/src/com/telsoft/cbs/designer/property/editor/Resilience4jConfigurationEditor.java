...
public class Resilience4jConfigurationEditor extends StringPropertyEditor {
    public void initEditor() {
        ...
        ((CBButton) this.editor).addActionListener(e -> {
            ...
            BeanEditor<Resilience4jConfigurationDefinition> beanEditor = new BeanEditor<>(null, true, Resilience4jConfigurationDefinition.class);
            beanEditor.init();
            beanEditor.setBean((Resilience4jConfigurationDefinition) ((CBButton) this.editor).getUserObject());
